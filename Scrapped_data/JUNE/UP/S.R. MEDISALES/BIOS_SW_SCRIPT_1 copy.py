...
def main():
    ...
    for line in lines:
        ...
        # if len(parts) > 15 and len(parts) < 17 :
        ...
        # if len(parts) > 12 and len(parts) < 14:
        # # if len(parts) > 8 and len(parts) < 10:
        # # # # # # # # # # # # if len(parts) > 13 and len(parts) < 15:
        #     # print(parts)

        #     medicine_name = parts[0] + " " + parts[1]   # The first part is the medicine name
        #     freeStrip = "0"
        ...
        # # # if len(parts) > 17 and len(parts) <= 19  :
        # if len(parts) > 13 and len(parts) < 15  :
        # # # # # # # # # # # if len(parts) > 7 and len(parts) < 9:
        #     # print(parts)
        #     medicine_name = parts[0] + " " + parts[1] + " " + parts[2]   # The first part is the medicine name
        #     freeStrip = "0"
        #     openingStrip = parts[-10] #Define Opening Strip Column Number if Formate Changes
        #     purchaseQty = parts[-9] #Define Purchase Qty Column Number if Formate Changes
        #     salesQty = parts[-5] #Define Sales Qty Column Number if Formate Changes
    ...
    df.to_excel(f"Scrapped_data/JUNE/UP/{folder_name}/{file_name}.xlsx", index=False) #Provide Excel file name Here
