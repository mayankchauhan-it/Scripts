...
def main():
    ...
    m_pattern = r'(?:[A-Z\.] + (?:MEDICAL|CLINIC|MEDICINCE|MED|medical|Medicals|MEDICO|MEDICINS|DRUG|ESSENSE|ENTERPRISE|MEDICINE|SALES|TRUST|RAJURA|MEDICOS|JUNAGADH|ADIPUR|MEDICO\'S|PHRAMACY|CHEMIST|STORE|STORES|MED.STORE|MED.& GEN.STORE|MEDI&GEN|SURGICALS|WELLNESS BEAUTY HUB|HUB|DAVA|PHARMA|GEN|GENERAL|WELLNESS|HOSPITAL|AUSHADHI|VERAVAL|MED.|DOCTOR)|JETPUR|JAMJODHPUR|DWARKA|JAMNAGAR|JAM-JODHPUR|DHROL|DR|INDORE|MORBI|BRAMHAPURI|MUL|GADCHANDUR|RAJURA|CHIMUR|\[.*\]|DR\..*)'
