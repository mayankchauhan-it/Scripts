...
def main():
    folder_name = "ARPAN MEDICAL AGENCY"
    stockiest_name = folder_name

    file_name = "ARPAN BIOS STATEMENT JUNE 23"
    ...
    for line in lines:
        ...
        #     medicine_name = " ".join(parts[0])    # The first part is the medicine name
        ...
        # if len(parts) == 10 or len(parts) == 12:
        #     print(parts)
        ...
        #         continue
        #     freeStrip = "0"
        #     openingStrip = parts[-9] #Define Opening Strip Column Number if Formate Changes
    ...
    df.to_excel(f"Scrapped_data/JUNE/MP/{folder_name}/{file_name}.xlsx", index=False) #Provide Excel file name Here
