...
def main():
    pdf_file_path = 'Scrapped_data/PDF/August_2023/UP/SACHDEVA MEDICALS/BIOS LAB 0109.pdf'  # Replace with the actual path to your PDF file
    stockiest_name = "SACHDEVA MEDICALS" #Modify the name of the stockiest
    ...
    #     if len(parts) > 10 and len(parts) < 12: #11 length

    #         medicine_name = parts[1] + " " + parts[2]
    #         freeStrip = "0" #Define Opening Strip Column Number if Formate Changes
    ...
    #     # if len(parts) > 9 and len(parts) < 11: #10 length

    #     #     medicine_name = parts[1] + " " + parts[2] + " " + parts[3] 
    #     #     freeStrip = "0" #Define Opening Strip Column Number if Formate Changes
    #     #     openingStrip = parts[-6]#Define Opening Strip Column Number if Formate Changes
    #     #     purchaseQty = parts[-5] #Define Purchase Qty Column Number if Formate Changes
    ...
    #     if len(parts) > 11 and len(parts) < 13: #12 length
    ...
    #     if len(parts) > 12 and len(parts) < 14: #13 length
    ...
    df.to_excel("Scrapped_data/Excel/Stock Wise/Gujarat/OPERA/bios derma june 23 ss.xlsx", index=False) #Provide Excel file name Here
